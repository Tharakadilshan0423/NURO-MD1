...
if(senderNumber.includes("94760534874")){
if(isReact) return
m.react("👨‍💻")
}       
...
app.get("/", (req, res) => {
res.send("hey,NURO-MD bot started✅");
});
